function clearHighlight() {
    ...
    const homeACard = document.getElementById("homeACard");
    const homeBCard = document.getElementById("homeBCard");

    homeA.classList.remove("highlight");
    homeB.classList.remove("highlight");
    homeACard.classList.remove("card-highlight");
    homeBCard.classList.remove("card-highlight");
}
